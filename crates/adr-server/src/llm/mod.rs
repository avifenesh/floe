...
//! `adr-mcp` child process, runs the agent loop, and returns the final
...
//!
//! ```text
//!   adr-server (this module)
//!        │
//!        │   JSON-RPC over stdio
//!        ├──────────────▶ adr-mcp child  ──────▶ artifact state + invariants
//!        │
//!        │   HTTP /api/chat
...
//! tool-call responses get forwarded to `adr-mcp`, and results flow back
